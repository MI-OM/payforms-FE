...
const navItems = [
  ...
  { label: "Notifications", path: "/contact/notifications", iconKey: "notifications" },
...
function ContactSidebar({ collapsed, onToggleCollapse }: { collapsed: boolean; onToggleCollapse: () => void }) {
