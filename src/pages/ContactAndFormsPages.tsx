...
import { Search, Plus, Filter, Download, Check, X, ArrowRight } from 'lucide-react'
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-surface-container-lowest rounded-xl p-8">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold">Company</label>
              <Input defaultValue="Studio H" />
            </div>
